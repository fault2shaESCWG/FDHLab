...
SoF = 2; % 2 = normal
T_logistic = readtable('../Regressions/TABLE_outputs/LOGISTIC_CombA_Mw7_SiteDim100_SiteDist2000_HW.txt');
...
plot(VDL,COND_PROB,'-','LineWidth',2,'color',rand(1,3),'display',...
    strcat('comb:A',',Mw:',num2str(Mw_scenario),...
...
writematrix([VDL',out],'Valori_probability_combA.txt')

 saveas(1,'COMB_A.pdf','pdf')
