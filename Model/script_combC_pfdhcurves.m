...
SoF = 2; % 2 = normal
T_logistic = readtable('../Regressions/TABLE_outputs/LOGISTIC_CombC_Mw7_SiteDim100_SiteDist2000_HW.txt');
...
plot(VDL,COND_PROB,'-','LineWidth',2,'color',rand(1,3),'display',...
    strcat('comb:C',',Mw:',num2str(Mw_scenario),...
...
writematrix([VDL',out],'Valori_probability_combC.txt')

 saveas(1,'COMB_C.pdf','pdf')
