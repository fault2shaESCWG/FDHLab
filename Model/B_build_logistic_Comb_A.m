...
mkdir(pathout1)
%%   user defined inputs
nameforfigure = 'CombA_Normal_m7_dist2000_dim100';
...
writetable(output,fullfile('TABLE_outputs',['LOGISTIC_CombA_Mw',num2str(m),'_SiteDim',num2str(site_dim),'_SiteDist',num2str(site_distance),'_',char(HWFW),'.txt']))
%%
